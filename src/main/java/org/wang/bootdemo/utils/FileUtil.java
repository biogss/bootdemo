...
public class FileUtil {
    ...
    private static Boolean readAndWriterFile(String sourceFileUrl, String newFileUrl){
    ...
    private static Boolean doStream(File sourceFile, File newFile) {
        ...
        System.out.println("非文本文件处理花费时间：" + (endTime - startTime) + "ms");
        return true;
    }
     ...
     */
     private static Boolean doText(File sourceFile, File newFile){
        ...
        long endTime = System.currentTimeMillis();
        System.out.println("文本处理花费时间：" + (endTime - startTime) + "ms");
        return true;
    }
